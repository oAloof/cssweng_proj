    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="bg-slate-900/20 backdrop-blur p-8 fixed inset-0 z-[10001] grid place-items-center overflow-y-scroll cursor-pointer"
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-violet-50 to-indigo-50/90 text-white rounded-lg w-full max-w-lg shadow-xl cursor-default z-[1000] relative overflow-y-auto overflow-x-hidden"
          >
